...
- Session history is the default working memory
- Minimal structured local memory provider or explicit no-op provider
- No autonomous extraction or consolidation until the vertical path is stable
