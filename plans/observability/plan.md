...
- Run, session, and correlation identifiers
- Structured events for model, tool, execution, error, cancellation, and completion activity
- Basic local trace viewer; no analytics dashboard
