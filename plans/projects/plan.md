...
- One active project with a versioned configuration file
- Workspace root, selected model, selected agent, assigned skills, and enabled tools
- Portable relative paths where practical
