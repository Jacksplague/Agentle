...
- What conservative character limit should the first configuration default use?
...
- How should an endpoint that accepts only one leading system message receive application and agent instructions: joined with separators or mapped by the adapter?
